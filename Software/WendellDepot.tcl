#!/usr/bin/wish
# Generated code: Sat Feb 15 22:06:52 EST 2025
...
MainWindow ctcpanel create Signal EastFM \
	...
	-orientation 4 \
	-heads 1
MainWindow ctcpanel create StraightBlock StageEastTrack3 \
	-x1 917.0 \
	-y1 90.0 \
	-x2 1041.0 \
	-y2 90.0 \
...
MainWindow ctcpanel create SIGPlate Stage_West_1_3_Sig \
	...
	-centercommand {} \
	-rightcommand {}
MainWindow ctcpanel create StraightBlock Stage_1 \
	-x1 16.0 \
	-y1 75.0 \
	-x2 79.0 \
	-y2 75.0 \
...
MainWindow ctcpanel create CodeButton East_Double_Track_code \
	...
	-controlpoint East_Double \
	-command {}
MainWindow ctcpanel create StraightBlock Stage_2 \
	-x1 16.0 \
	-y1 110.0 \
	-x2 79.0 \
	-y2 110.0 \
...
MainWindow ctcpanel create Signal WestExit1 \
	...
	-orientation 0 \
	-heads 1
MainWindow ctcpanel create StraightBlock Stage_3 \
	-x1 17.0 \
	-y1 55.0 \
	-x2 77.0 \
	-y2 55.0 \
...
MainWindow ctcpanel create Signal WestExit2 \
	...
	-orientation 0 \
	-heads 1
MainWindow ctcpanel create StraightBlock EastStageTrack1 \
	-x1 918.0 \
	-y1 110.0 \
	-x2 1040.0 \
	-y2 110.0 \
	...
	-position above \
	-occupiedcommand {}
MainWindow ctcpanel create StraightBlock Stage_4 \
	-x1 16.0 \
	-y1 131.0 \
	-x2 75.0 \
	-y2 131.0 \
	...
	-position below \
	-occupiedcommand {}
MainWindow ctcpanel create StraightBlock EastStageTrack2 \
	-x1 911.0 \
	-y1 148.0 \
	-x2 1042.0 \
	-y2 148.0 \
...
MainWindow ctcpanel create Signal WestExit4 \
	...
	-orientation 0 \
	-heads 1
MainWindow ctcpanel create StraightBlock EastStageTrack4 \
	-x1 911.0 \
	-y1 170.0 \
	-x2 1046.0 \
	-y2 170.0 \
...
MainWindow ctcpanel create SWPlate East_Double_Track_Plate \
	...
	-normalcommand {} \
	-reversecommand {}
MainWindow ctcpanel create StraightBlock WestMainTrack2a \
	-x1 310.0 \
	-y1 75.0 \
	-x2 319.0 \
	-y2 89.0 \
...
# OpenLCB_Dispatcher StageEastTrack3 -eleclasstype Block
OpenLCB_Dispatcher create %AUTO% -name StageEastTrack3 \
	-eleclasstype Block \
...
# OpenLCB_Dispatcher Stage_1 -eleclasstype Block
OpenLCB_Dispatcher create %AUTO% -name Stage_1 \
	-eleclasstype Block \
...
# OpenLCB_Dispatcher Stage_2 -eleclasstype Block
OpenLCB_Dispatcher create %AUTO% -name Stage_2 \
	-eleclasstype Block \

# OpenLCB_Dispatcher WestExit1 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.84 Hold 05.01.01.01.22.83.00.85 Go}
...
# OpenLCB_Dispatcher Stage_3 -eleclasstype Block
OpenLCB_Dispatcher create %AUTO% -name Stage_3 \
	-eleclasstype Block \

# OpenLCB_Dispatcher WestExit2 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.88 Hold 05.01.01.01.22.83.00.89 Go}
...
# OpenLCB_Dispatcher EastStageTrack1 -eleclasstype Block
OpenLCB_Dispatcher create %AUTO% -name EastStageTrack1 \
	-eleclasstype Block \

# OpenLCB_Dispatcher Stage_4 -eleclasstype Block
OpenLCB_Dispatcher create %AUTO% -name Stage_4 \
	-eleclasstype Block \

# OpenLCB_Dispatcher EastStageTrack2 -eleclasstype Block
OpenLCB_Dispatcher create %AUTO% -name EastStageTrack2 \
	-eleclasstype Block \

# OpenLCB_Dispatcher WestExit3 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.80 Hold 05.01.01.01.22.83.00.81 Go}
...
# OpenLCB_Dispatcher WestExit4 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.C0 Hold 05.01.01.01.22.83.00.C1 Go}
...
# OpenLCB_Dispatcher EastStageTrack4 -eleclasstype Block
OpenLCB_Dispatcher create %AUTO% -name EastStageTrack4 \
	-eleclasstype Block \

# OpenLCB_Dispatcher WestF1 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.81.00.60 Stop 05.01.01.01.22.81.00.61 Aproach 05.01.01.01.22.81.00.62 {Slow Clear}}
...
# OpenLCB_Dispatcher EastExit1 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.F8 Hold 05.01.01.01.22.83.00.F9 Go}
...
# OpenLCB_Dispatcher EastExit2 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.F4 Hold 05.01.01.01.22.83.00.F5 Go}
...
# OpenLCB_Dispatcher EastExit3 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.FC Hold 05.01.01.01.22.83.00.FD Go}
...
# OpenLCB_Dispatcher EastExit4 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.F0 Hold 05.01.01.01.22.83.00.F1 Go}
...
# OpenLCB_Dispatcher WestEN -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.81.00.40 Stop 05.01.01.01.22.81.00.41 {Slow Aproach} 05.01.01.01.22.81.00.42 {Slow Clear} 05.01.01.01.22.81.00.43 Aproach 05.01.01.01.22.81.00.44 Clear}
...
# OpenLCB_Dispatcher EastYardEntry1-3 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.D0 Stop 05.01.01.01.22.83.00.D1 {Slow Aproach} 05.01.01.01.22.83.00.D2 {Slow Clear} 05.01.01.01.22.83.00.D3 Aproach 05.01.01.01.22.83.00.D4 Clear}
...
# OpenLCB_Dispatcher EastF1 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.82.00.50 Stop 05.01.01.01.22.82.00.51 {Slow Aproach} 05.01.01.01.22.82.00.52 {Slow Clear}}
...
# OpenLCB_Dispatcher WestYardEntry1-3 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.60 Stop 05.01.01.01.22.83.00.61 {Slow Aproach} 05.01.01.01.22.83.00.62 {Slow Clear} 05.01.01.01.22.83.00.63 Aproach 05.01.01.01.22.83.00.64 Clear}
...
# OpenLCB_Dispatcher WestFM -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.81.00.50 Stop 05.01.01.01.22.81.00.51 Aproach 05.01.01.01.22.81.00.52 Clear}
...
# OpenLCB_Dispatcher WestMainTrack2a -eleclasstype Block
OpenLCB_Dispatcher create %AUTO% -name WestMainTrack2a \
	-eleclasstype Block \
...
OpenLCB_Dispatcher create %AUTO% -name Stage_West_2_4 \
	...
	-statenormaleventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.83.00.50}] \
	-statereverseeventid [lcc::EventID %AUTO% -eventidstring {05.01.01.01.22.83.00.51}]
# OpenLCB_Dispatcher EastYardEntry2-4 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.E0 Stop 05.01.01.01.22.83.00.E1 {Slow Aproach} 05.01.01.01.22.83.00.E2 {Slow Clear} 05.01.01.01.22.83.00.E3 Aproach 05.01.01.01.22.83.00.E4 Clear}
...
# OpenLCB_Dispatcher WestYardEntry2-4 -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.83.00.70 Stop 05.01.01.01.22.83.00.71 {Slow Aproach} 05.01.01.01.22.83.00.72 {Slow Clear} 05.01.01.01.22.83.00.73 Aproach 05.01.01.01.22.83.00.74 Clear}
...
# OpenLCB_Dispatcher EastEN -eleclasstype Signal -eventidaspectlist {05.01.01.01.22.82.00.40 Stop 05.01.01.01.22.82.00.41 {Slow Aproach} 05.01.01.01.22.82.00.42 {Slow Clear} 05.01.01.01.22.82.00.43 Aproach 05.01.01.01.22.82.00.44 Clear}
...
snit::type DispatcherLogic {
        ...
        constructor {args} {
            ...
            puts stderr "*** DispatcherLogic create: [[lindex $Signals 0] configure]"
            set Turnouts [::OpenLCB_Dispatcher GetElementByType Switch]    
            puts stderr "*** DispatcherLogic create: [[lindex $Turnouts 0] configure]"
